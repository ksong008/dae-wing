	...
	return map[string]any{
		...
		"CacheStatsResource": map[string]any{
			...
			"properties": map[string]any{
				...
				"redirectTrackEntries":     map[string]any{"type": "integer"},
				"routingTuplesEntries":     map[string]any{"type": "integer"},
				"domainRoutingEntries":     map[string]any{"type": "integer"},
				"udpConnStateEntries":      map[string]any{"type": "integer"},
				"cookiePidEntries":         map[string]any{"type": "integer"},
				"tgidPnameEntries":         map[string]any{"type": "integer"},
