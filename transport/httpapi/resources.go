...
func handleDNSResources(rw http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		model := db.Dns{
			Name: optionalString(req.Name),
			Dns:  normalizeSection(req.DNS, engine.Default().EmptyDnsSection()),
		}
...
func handleDNSResource(rw http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPut:
		...
		if req.DNS != nil {
			dnsSection := normalizeSection(req.DNS, engine.Default().EmptyDnsSection())
...
func handleRoutings(rw http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		model := db.Routing{
			Name:    optionalString(req.Name),
			Routing: normalizeSection(req.Routing, engine.Default().EmptyRoutingSection()),
		}
...
func handleRoutingResource(rw http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPut:
		...
		if req.Routing != nil {
			routingSection := normalizeSection(req.Routing, engine.Default().EmptyRoutingSection())
